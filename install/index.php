...
switch (isset($_GET['act']) ? $_GET['act'] : null) {
    case 'set':
        ...
        if (empty($error)) {
            ...
            echo '<ul>При желании, Вы можете установить <a href="/install/index.php?act=demo&amp;id=' . $user_id . '&amp;ps=' . $_POST['wpassadmina'] .
    ...
    case "admin":
        ...
        echo '<form method="post" action="/install/index.php?act=set">';
    ...
    case 'db':
        ...
        ////////////////////////////////////////////////////////////
        echo '<form action="/install/index.php?act=admin" method="POST">';
        echo
    ...
    case 'check':
        ...
        $arr = array(
            'files/avatar/', 'files/photo/', 'cache/', 'incfiles/', 'gallery/foto/', 'gallery/temp/', 'library/files/', 'library/temp/', 'pratt/', 'forum/files/', 'forum/temtemp/', 'download/arctemp/', 'download/files/', 'download/graftemp/', 'download/screen/',
        ...
        switch ($err) {
            ...
            default:
                echo '<span class="green">Отлично!</span><br />Все настройки правильные.<p><a class="button" href="/install/index.php?act=db">Продолжить установку</a></p>';
        }
        break;
    ...
    default:
        ...
        echo '</ul><hr /><a class="button" href="/install/index.php?act=check">Начать установку</a>';
        break;
}
